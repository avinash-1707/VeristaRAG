  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-6 pt-24 pb-20 md:px-12">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, rgba(212,88,10,0.13) 1px, transparent 1px)",
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-10">
        <motion.div style={{ y: heroY, opacity: heroOpacity }}>
          ...
          <div className="mb-6">
            ...
            <div className="mt-[0.04em] overflow-hidden">
              <motion.p
                ...
                style={{
                  background:
                    "linear-gradient(120deg, #f0905a 0%, #e8751a 25%, #d4580a 55%, #b84208 100%)",
          ...
          <motion.p
            ...
            className="mb-9 max-w-104 text-lg leading-relaxed"
          ...
          >
            <Link
              ...
              style={{
                ...
                boxShadow:
                  "0 0 28px 8px rgba(212,88,10,0.45), inset 0 1px 0 rgba(255,255,255,0.15)",
              }}
            >
              Get Started Now
          ...
          >
            {["Zero hallucination", "Exact citations", "< 3s response"].map(
              (item) => (
                <span
                  key={item}
